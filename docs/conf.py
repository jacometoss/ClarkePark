# -*- coding: utf-8 -*-
#
# entrenamiento.python_basico documentation build configuration file,
# created by sphinx-quickstart on Sun Jun  1 01:09:00 2014.
#
...
_stdauthor = r''
latex_documents = [
  ('index', 'clarkepark.tex',
   u' Transformación de Clarke & Park',
   _stdauthor, 'manual'),
]
...
# texinfo_documents = [
#  ('index', 'entrenamientopython_basico',
#   u'Materiales del curso de programación en Python - Nivel básico',
#   u'Marco Polo Jácome Toss', 'entrenamientopython_basico',
#   'Libreria de marcos de referencias alphaBeta, Dq0',
#   'Miscellaneous'),
# ]
...
# epub_author = u'Marco Polo Jácome Toss'
# epub_publisher = u'https://clarkepark.readthedocs.io/'
# epub_copyright = u'2020-2021, Marco Polo Jácome Toss'
